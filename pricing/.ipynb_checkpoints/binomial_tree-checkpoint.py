...
if __name__ == "__main__":
    ...
    for N_test in (10, 50, 100, 500):
        c = binomial_crr_price(S0_test, K_test, r_test, vol_test, T_test, N_test, is_call=True)
        p = binomial_crr_price(S0_test, K_test, r_test, vol_test, T_test, N_test, is_call=False)
